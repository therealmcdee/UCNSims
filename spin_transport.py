...
neutron_log = neutron_stepper(neutrons, temp, m_neutron, t_span = 0.1, bounds = bounds, decay = False, spin_tracking = True, stcfield = True)#coef = coef)
